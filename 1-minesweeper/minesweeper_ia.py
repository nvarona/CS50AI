# File: minesweeper_ia.py
# Author: Natxo Varona (nvarona@gmail.com)
# Date: 24/07/2024 (última actualización: DD/MM/AAAA)
# Version: 1.0
# Description: Logica del programa del buscaminas y la IA para resolver la jugada
#
# Requirements: Python 3.9 o superior
# Dependencies: pygame, sys, time, random, itertools
#               runner.py minesweeper_ia.py
# License: MIT License (o la licencia que consideres apropiada)
#
# Change log:
# - 24/07/2024: primera version de adaptacion de las funciones que faltan.
# - 25/07/2024: Ajustes y optimizacion del codigo para resolver todo el juego ella sola.
...
class MinesweeperAI():
    ...
    def update_knowledge(self):
        """
        Updates the knowledge base with new safe and mine cells.
        """
        for sentence in self.knowledge:
